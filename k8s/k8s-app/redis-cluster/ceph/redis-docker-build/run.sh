...
function launchmaster() {
  ...
  sed -i "s/%redis-pass%/${REDIS_PASS}/g" /redis-master/redis.conf
...
function launchslave() {
  ...
  sed -i "s/%master-port%/6379/g" /redis-slave/redis.conf
  sed -i "s/%redis-pass%/${REDIS_PASS}/g" /redis-slave/redis.conf
