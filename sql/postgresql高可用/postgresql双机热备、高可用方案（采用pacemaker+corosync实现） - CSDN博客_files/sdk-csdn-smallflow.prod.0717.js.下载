(function(window,document/*,undefined*/){
  ...
  function renderPureText($view, item) {
    ...
    var itemIdToItemData = {
      'bigdata110': {
        title: '<span style="color: red">大数据</span>开发<span style="color: red">薪资</span>多少？'
      },
      'python110': {
        title: '2018年<span style="color: red">Python</span>全栈平均<span style="color: red">薪资</span>是多少？'
      },
      'blockchain10': {
        title: '<span style="color: red">区块链以太坊</span>DApp开发为什么人才<span style="color: red">稀少？薪资</span>到底有多高？'
      },
      'ai10': {
        title: '2018年<span style="color: red">人工智能</span>工程师平均<span style="color: red">年薪</span>是多少？'
      }
    };
